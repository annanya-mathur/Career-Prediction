...
def on_click():
    try:
        ...
        a=n_apt
        b=n_test
        Label(main_window , font=("Arial", 20),text="Predicted Career Choices",foreground='red').pack(pady=20)
...
Button (main_window,font=("Arial", 15), text = "Submit",foreground='green',command=on_click).pack(pady=20)
